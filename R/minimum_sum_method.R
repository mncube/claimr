...
#'
#' @return "The number...of universe payments which are completely in error (Or, for partial overpayment scenarios, seriously in error—see Section 4.2.)"
#' @export
#'
#' @examples
...
{
  # a bisection routine to find a lower 1-alpha confidence bound for Ne, the number of
  #population items in error. Population size Npop, SRS size nsamp, ne = number of
  #sample items in error.
